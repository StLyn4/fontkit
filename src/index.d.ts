// Type definitions for @lyn4ed/fontkit
// Project: https://github.com/StLyn4/fontkit#readme
// Definitions by: Stepan Mikhailiuk <https://github.com/stepancar>, Vsevolod Volkov <https://github.com/StLyn4>
...
export interface Font {
  ...
  italicAngle: number;
  /** is the vertical space between adjacent lines (their baselines) of text, also known as leading */
  lineHeight: number;
